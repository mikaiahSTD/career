package com.rmm.std.endpoint.event.consumer;

import com.rmm.std.PojaGenerated;
import com.rmm.std.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.rmm.std.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.rmm.std.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
