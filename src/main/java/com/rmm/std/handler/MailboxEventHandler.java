...
import static com.rmm.std.concurrency.ThreadRenamer.renameWorkerThread;
...
import com.rmm.std.PojaApplication;
import com.rmm.std.PojaGenerated;
import com.rmm.std.endpoint.EndpointConf;
import com.rmm.std.endpoint.event.EventConf;
import com.rmm.std.endpoint.event.consumer.EventConsumer;
import com.rmm.std.endpoint.event.consumer.model.ConsumableEvent;
import com.rmm.std.endpoint.event.consumer.model.ConsumableEventTyper;
